...
spotchecks = builder.spotcheck(schema=DividendExtraction, model="gpt-4o-mini", entries=entries,
               results=results, sample_size=10, rpm=500, tpm=200_000, rpm_threshold=0.75, tpm_threshold=0.75)
print(spotchecks)

builder.spotcheck_visualize(schema=DividendExtraction, model="gpt-4o-mini", entries=entries,
               results=results, sample_size=10, rpm=500, tpm=200_000, rpm_threshold=0.75, tpm_threshold=0.75)
