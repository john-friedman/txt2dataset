# custom_openai_quickstart.py
# Uses OpenAIAPIBuilder with a custom endpoint and auth header.
# Works with Azure OpenAI, or any OpenAI-compatible API that supports
# structured outputs (response_format with json_schema strict mode).

from txt2dataset import OpenAIAPIBuilder, estimate_entries_tokens
...
# Replace these with your Azure deployment details
AZURE_API_KEY = "your-azure-api-key"
AZURE_DEPLOYMENT = "gpt-4o-mini"  # or gpt-4o, gpt-5.2, etc.

ENDPOINT = "endpoint"

builder = OpenAIAPIBuilder(
    api_key=AZURE_API_KEY,
    endpoint=ENDPOINT,
    auth_header="api-key",
)

results, errors = builder.build(prompt=prompt, schema=DividendExtraction, model=AZURE_DEPLOYMENT,
